...
export function NavBar({ items, className }: NavBarProps) {
  ...
  return (
    ...
    >
      <div className="flex items-center gap-1 bg-white/95 border border-slate-200 backdrop-blur-lg py-1.5 px-1.5 rounded-full shadow-lg">
        {items.map((item) => {
          ...
          return (
            ...
            >
              ...
              {isActive && (
                <motion.div
                  layoutId="lamp"
                  className="absolute inset-0 w-full bg-indigo-100/50 rounded-full -z-10"
                  initial={false}
                  transition={{
                    type: "spring",
                    stiffness: 300,
